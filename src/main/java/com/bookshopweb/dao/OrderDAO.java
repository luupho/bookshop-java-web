...
public interface OrderDAO extends DAO<Order> {
    ...
    @SqlQuery("SELECT * FROM orders WHERE createdAt >= :startDate AND createdAt < :endDate")
    List<Order> getOrdersByDateRange(@Bind("startDate") LocalDate startDate, @Bind("endDate") LocalDate endDate);
