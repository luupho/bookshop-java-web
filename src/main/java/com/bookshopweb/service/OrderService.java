...
public class OrderService extends Service<Order, OrderDAO> implements OrderDAO {
    ...
    // Thêm phương thức mới để lấy danh sách đơn hàng trong khoảng thời gian
    public List<Order> getOrdersByDateRange(LocalDate startDate, LocalDate endDate) {
        return jdbi.withExtension(OrderDAO.class, dao -> dao.getOrdersByDateRange(startDate, endDate));
    }
}
