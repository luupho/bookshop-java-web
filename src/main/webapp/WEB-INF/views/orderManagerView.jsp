...
<section class="section-content">
  <div class="container">
    ...
    <div class="search-order-by-date my-2 d-flex align-items-center">
      <form action="${pageContext.request.contextPath}/admin/orderManager" method="get" class="d-flex align-items-center">
        <div class="mb-3 me-2 d-flex">
          <label for="startDate" class="form-label me-2" style="min-width: 70px;">Từ ngày:</label>
          <input type="date" id="startDate" name="startDate" required class="form-control d-flex">
        </div>

        <div class="mb-3 me-2 d-flex">
          <label for="endDate" class="form-label me-2" style="min-width: 80px; margin-left: 20px;">Đến ngày:</label>
          <input type="date" id="endDate" name="endDate" required class="form-control d-flex">
        </div>

        <div class="ms-3" style="margin-bottom: 12px;">
          <button type="submit" class="btn btn-primary">Tìm</button>
        </div>
      </form>

      <!-- Add this line to display the total amount -->
      <c:if test="${not empty totalAmount}">
          <div style="margin-left: 60px; font-size: 25px; margin-bottom: 12px">Tổng tiền: <fmt:formatNumber pattern="#,##0" value="${totalAmount}"/>₫</div>
      </c:if>
    </div>
